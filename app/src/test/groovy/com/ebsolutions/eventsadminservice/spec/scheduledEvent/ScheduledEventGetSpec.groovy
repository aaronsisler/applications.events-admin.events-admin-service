...
class ScheduledEventGetSpec {
    ...
    def "Get a scheduled event: URL Client id exists: Get Single Scheduled Event: Scheduled event exists"() {
        ...
        and: "the correct scheduled event is returned"
            ...
            Assertions.assertEquals(ScheduledEventTestConstants.GET_SCHEDULED_EVENT_SINGLE.getOrganizerIds().get(0), eventSchedule.getOrganizerIds().get(0))
            Assertions.assertEquals(ScheduledEventTestConstants.GET_SCHEDULED_EVENT_SINGLE.getOrganizerIds().get(1), eventSchedule.getOrganizerIds().get(1))
    ...
    def "Get a scheduled event: URL Client id exists: Get Reoccurring Standard Scheduled Event: Scheduled event exists"() {
        ...
        and: "the correct scheduled event is returned"
            ...
            Assertions.assertEquals(ScheduledEventTestConstants.GET_SCHEDULED_EVENT_REOCCURRING_STANDARD.getOrganizerIds().get(0), eventSchedule.getOrganizerIds().get(0))
            Assertions.assertEquals(ScheduledEventTestConstants.GET_SCHEDULED_EVENT_REOCCURRING_STANDARD.getOrganizerIds().get(1), eventSchedule.getOrganizerIds().get(1))
    ...
    def "Get a scheduled event: URL Client id exists: Get Reoccurring Weekly Scheduled Event: Scheduled event exists"() {
        ...
        and: "the correct scheduled event is returned"
            ...
            Assertions.assertEquals(ScheduledEventTestConstants.GET_SCHEDULED_EVENT_REOCCURRING_WEEKLY.getOrganizerIds().get(0), eventSchedule.getOrganizerIds().get(0))
            Assertions.assertEquals(ScheduledEventTestConstants.GET_SCHEDULED_EVENT_REOCCURRING_WEEKLY.getOrganizerIds().get(1), eventSchedule.getOrganizerIds().get(1))
