...
class EventSpec extends Specification {
    ...
    def "Get an event: URL Client id exists: Event Exists"() {
        ...
        and: "the correct event is returned"
            ...
            Assertions.assertEquals(EventTestConstants.GET_EVENT.getOrganizerId(), event.getOrganizerId())
    ...
    def "Get all events: URL Client id exists: Events exist for client"() {
        ...
        and: "the correct events are returned"
            ...
            Assertions.assertEquals(EventTestConstants.getAllEventsOrganizerId, firstEvent.getOrganizerId())
            ...
            Assertions.assertEquals(EventTestConstants.getAllEventsOrganizerId, secondEvent.getOrganizerId())
    ...
    def "Create an event: URL Client id exists: Create event is successful"() {
        ...
        and: "the event is valid"
            Event newEvent = Event.builder()
                    ...
                    .organizerId(EventTestConstants.CREATE_EVENT.getOrganizerId())
                    .name(EventTestConstants.CREATE_EVENT.getName())
        ...
        and: "the correct event is returned"
            ...
            Assertions.assertEquals(EventTestConstants.CREATE_EVENT.getOrganizerId(), event.getOrganizerId())
        ...
        and: "the new event is correct in the database"
            ...
            Assertions.assertEquals(EventTestConstants.CREATE_EVENT.getOrganizerId(), databaseEvent.getOrganizerId())
    ...
    def "Update an event: URL Client id exists: Update event is successful"() {
        ...
        and: "a valid update is made to the event"
            Event updatedEvent = CopyObjectUtil.event(initResponse.body())
            updatedEvent.setOrganizerId(EventTestConstants.updateEventUpdateOrganizerId)
        ...
        and: "the updated event is returned in the response"
            ...
            Assertions.assertEquals(EventTestConstants.updateEventUpdateOrganizerId, returnedEvent.getOrganizerId())
        ...
        and: "the event is correct in the database"
            ...
            Assertions.assertEquals(EventTestConstants.updateEventUpdateOrganizerId, databaseEvent.getOrganizerId())
